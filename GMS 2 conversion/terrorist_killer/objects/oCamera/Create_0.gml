...
view_width_default = 400;
view_height_default = 300;
...
global.camera = camera_create_view(0, 0, view_width, view_height, 0, -1, -1, -1, 0, 0);

// Set target view to use our camera.
view_set_camera(target_view, global.camera);
